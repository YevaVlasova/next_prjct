                ...
                <div className="row mt-70 mb-50">
                    {categories.slice(0, 12).map((item, i) => (
                        <div className="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6" key={i}>
                            <div className="card-style-2 d-flex flex-column gap-2 hover-up hover-neon wow animate__animated animate__fadeIn" data-wow-delay={`${i/10}s`}>
                                ...
                                <div className="card-info">
                                    <p className="color-gray-500 text-small">{item.title}</p>
                                </div>
                            </div>
                        </div>
                    ))}
