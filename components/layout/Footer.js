                        ...
                        <div className="row">
                            <div className="col-lg-4 mb-30">
                                ...
                                <p className="mb-20 mt-20 text-sm color-gray-500 wow animate__animated animate__fadeInUp">
                                    Юридична особа Асоціація "АСОЦІАЦІЯ ДІЛОВОГО СПІВРОБІТНИЦТВА УКРАЇНИ ТА ДЕРЖАВ АСЕАН"(скорочено Асоціація «Україна-АСЕАН-Бізнес»)
                                </p>
                                <h6 className="color-white mb-5 wow animate__animated animate__fadeInUp">Адреса</h6>
                                <p className="text-sm color-gray-500 wow animate__animated animate__fadeInUp">
                                    01030, Україна, місто Київ, 
                                    <br />
                                    вул. Б. Хмельницького, будинок 26, офіс 5-8
                                </p>
                                <a className="mt-20 text-lg color-gray-500" href="mailto:amblytvyn@gmail.com">amblytvyn@gmail.com</a>
                            </div>
                            <div className="col-lg-4 mb-30">
                        ...
                        <div className="footer-bottom border-gray-800">
                            <div className="row">
                                <div className="col-lg-5 text-center text-lg-start">
                                    <p className="text-base color-white wow animate__animated animate__fadeIn">© 1997-<CurrentYear /> Created by<Link className="copyright" href="https://abc-digital.com" target="_blank"> ABC Digital</Link></p>
                                </div>
